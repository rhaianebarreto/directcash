...
**Código da atualização: `editor-2026-09-25-r6`**
...
3. Copie todo o [código de atualização oficial](https://github.com/rhaianebarreto/directcash/blob/editor-2026-09-25-r6/.github/workflows/atualizar-directcash.yml), substitua o conteúdo do seu arquivo e confirme em **Commit changes**.
...
Se você já instalou a revisão `editor-2026-09-25-r2` com o código de atualização daquela revisão, pode pular essa preparação. Nas versões anteriores, substitua o arquivo conforme acima para aceitar o código com `-r6`.
...
3. No campo do código, coloque **editor-2026-09-25-r6** e confirme **Run workflow**.
...
Para conferir a versão, acrescente `/version.json` ao endereço do painel. Deve aparecer `editor-2026-09-25-r6`.
...
Toda caixa tem uma bolinha dourada na borda direita, sem texto. Arraste essa bolinha até a entrada da próxima caixa e salve.
