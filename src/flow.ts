...
export type Flow={version:1;map?:MapFlow;match:'contains'|'exact'|'any';channels?:string[];storyId?:string;allPosts:boolean;welcomeEnabled:boolean;welcomeText:string;welcomeButton:string;requireFollow:boolean;followText:string;collectEmail:boolean;emailText:string;linkEnabled:boolean;linkLabel:string;attachmentType:''|'image'|'audio'|'video';attachmentUrl:string;followupEnabled:boolean;followupMinutes:number;followupText:string;followupLink:string;followupLabel:string};
